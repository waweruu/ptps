...
public class STKPush {
    ...
    public static class Builder {
        ...
        public Builder(String businessShortCode,String passkey, int amount, String partyB, String phoneNumber, String callBackURL){
